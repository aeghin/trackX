...
const Home = () => {
    ...
    return (
        <>
            <div className="bg-[#f1f5f9] flex flex-col justify-center items-center h-screen border-b-4 border-indigo-200">
                <div className="animate-swoop-in flex flex-col justify-center items-center">
                    ...
                    <h2 className="italic font-mono mb-4">
                        Keep your conflicts in control, <span className='text-indigo-600'>always.</span>
                    </h2>
