        ...
        <>
            ...
            <div className="bg-[#f1f5f9] flex flex-col justify-center items-center h-screen pb-36">
                <div className="animate-swoop-in flex flex-col justify-center items-center">
                    ...
                    <button onClick={() => navigate("/login")} className="mx-auto w-1/4 bg-black text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-black focus:ring-opacity-50 transition duration-300">
                        Try for Free!
                    </button>
                </div>
            </div>
