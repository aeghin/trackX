        ...
        <>
            ...
            <div className="relative flex flex-col justify-center items-center h-screen border-b-4 border-t-4 border-indigo-200 bg-cover bg-center"
                ...
                <div ref={sectionRef} className="z-10 p-4 flex flex-col justify-center items-center p-4">
                    ...
                    <h2 className="italic text-gray-400 font-mono mb-4 mt-2 text-xl">
                        Keep your conflicts in control, <span className='text-indigo-400'>always.</span>
                    </h2>
                    <button onClick={clickHandler} className="mx-auto w-[220px] bg-white text-xl text-black font-semibold py-4 rounded-lg shadow-md hover:bg-indigo-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-black focus:ring-opacity-50 transition duration-300">
                        Register for free!
                    </button>
                    <button onClick={onSubmit} className="text-xl mt-2 text-gray-400 hover:text-indigo-400 focus:outline-none">
                        or try the app!
                    </button>
                </div>
            </div>
